  ...
  return (
    <PageSection>
      <div className="flex items-center gap-2 justify-between">
        <SectionTitle
          title="NEWS & UPDATES"
          label="What’s Happening at Our School"
        />
        <SecondaryButton className="max-md:hidden">
          View More Updates
        </SecondaryButton>
      </div>
      <div className="flex flex-col xl:flex-row gap-8">
        <div className="flex flex-col gap-5 sm:flex-row xl:flex-col">
          <div className="sm:w-1/2 xl:w-full relative rounded-sm overflow-hidden">
            ...
            />
            <div className="absolute top-1 left-1 bg-primary-blue text-white py-2 px-4 rounded-sm w-fit text-xs font-semibold">
              {post1.category}
            </div>
          </div>
          <div className="flex flex-col justify-between gap-4 flex-1">
            <div className="flex items-center text-xs text-primary-blue font-semibold">
            ...
            <Link
              href={`/posts/${post1.id}`}
              className="text-white bg-primary-blue hover:bg-blue1 transition-colors flex items-center py-2 px-4 gap-4 w-fit rounded-sm text-sm font-medium"
            >
        ...
        <SecondaryButton className="md:hidden">
          View More Updates
        </SecondaryButton>
      </div>
    </PageSection>
